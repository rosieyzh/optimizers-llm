...
class OptimizerType(StrEnum):
    ...
    adalayerw = "adalayerw"
    adafactorw_last = "adafactorw_last"
    adalayerw_last = "adalayerw_last"
    sgdw = "sgdw"
    sophiag = "sophiag"
...
class OptimizerConfig(BaseConfig):
    ...
    t_freeze: Optional[int] = None # freezing exp_av_sq from time t onwards
    update_last: bool = True # whether to continue updating last layer for adalayer and SGD + Adalayer.
    update_norm: bool = False # whether to continue updating norm layers for adalayer and SGD+ Adalayer.
    no_norm_training: bool = False # option to turn off LN training.

    # For SGD + Adalayer, either set last layer lr directly or as a multiplicative factor of SGD lr.
    lr_last: Optional[float] = None # learning rate for last layer
    lr_last_multiplier: Optional[float] = None # learning rate multiplier for last layer
...
class SchedulerType(StrEnum):
    ...
    freeze_cosine_with_warmup = "freeze_cosine_with_warmup"
